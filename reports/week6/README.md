...
>
> Примечание: черновик-скелет. Пункты с `TODO` заполняются по мере прохождения спринта,
> встречи с заказчиком, ревью и релиза.
...
## Бэклог и спринт
- **2. Product Backlog board:** TODO — ссылка на GitHub Projects view.
- **3. Sprint 6 Backlog board:** TODO — ссылка на доску/фильтр по milestone #4.
...
- **6. Sprint 6 size (SP):** TODO.

## Trial-релиз
- **7. Сводка изменений Week 6 trial:** TODO.
...
- **15. Итог ревью документации заказчиком** (что ясно / неясно / чего не хватает): TODO.
...
## Итоги
- **29. Текущий статус продукта и ожидаемая работа Week 7:** TODO.
- **30. Contribution traceability:**

  | Участник | Роль | Issues | PR / ревью | Тесты / доки / передача / деплой |
  |---|---|---|---|---|
  | Илья | Frontend + передача/handover | TODO | TODO | TODO |
  | Айрат | Backend (тех. части) | TODO | TODO | TODO |
  | Александр | Backend (тех. части) | TODO | TODO | TODO |

- **31. Скриншоты** (`images/`): milestone, релиз, пример review-linked PR, прочие пруфы — TODO.
