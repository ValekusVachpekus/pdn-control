...
- [backlog.md](backlog.md) — counted Product Backlog (16 PBIs), Story-Point estimation
  (**total = 95 SP**), DEEP rationale, the current Sprint Backlog (Sprint 1, 21 SP), and the
...
- Promoted 3 existing bugs/tasks (#34, #54, #55) into full PBIs and added a CI testing PBI
  (#71) → 16 counted PBIs.
